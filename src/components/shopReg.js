    ...
    return (
      <div className="wrap4">
        <div className="form-wrap4">
          ...
          <h1 className="oni">Business Registration Account</h1>
          
          <form  method="post"  name="userRegistrationForm"  onSubmit= {this.submituserRegistrationForm}className="LoginForm">
        
          <label>Name</label>
        <input type="text" name="shopname" value={this.state.fields.shopname} onChange={this.handleChange} className="xcs4"/>
        <div className="errorMsg">{this.state.errors.shopname}</div>
        <label>Email:</label>
        <input type="text" name="email" value={this.state.fields.email} onChange={this.handleChange} className="xcs4" />
        <div className="errorMsg">{this.state.errors.email}</div>
        <label>Mobile No:</label>
        <input type="text" name="mobile" value={this.state.fields.mobile} onChange={this.handleChange} className="xcs4"  />
        <div className="errorMsg">{this.state.errors.mobile}</div>
        <label>Password</label>
        <input type="password" name="password" value={this.state.fields.password} onChange={this.handleChange}className="xcs4" />
        <div className="errorMsg">{this.state.errors.password}</div>
        <label>Address:</label>
        <input type="text" name="address" value={this.state.fields.address} onChange={this.handleChange} className="xcs4"/>
        <div className="errorMsg">{this.state.errors.address}</div>
        <label>Account Number:</label>
        <input type="text" name="account" value={this.state.fields.account} onChange={this.handleChange} className="xcs4"/>
        <div className="errorMsg">{this.state.errors.account}</div>
        <label>Business Registration Number:</label>
        <input type="text" name="bisreg" value={this.state.fields.bisreg} onChange={this.handleChange} className="xcs4"/>
...
<label>
              ...
              <div><br></br><center>
              <input type="submit" className="but4" value="Register" />
              </center>
              </div>
          </form>
        </div>
