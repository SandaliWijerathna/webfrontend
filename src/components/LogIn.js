        ...
        <div className="form-wrap1">
          ...
          <form  method="post"  name="userRegistrationForm"  onSubmit= {this.submituserRegistrationForm}className="LoginForm">
           <div className="firName">
             <br></br>
             <br></br>
              <label className="lbl1" htmlFor="exampleEmail">Email </label>
              <input
           ...
           <div className="firName">
             <br></br>
              <label className="lbl1" htmlFor="examplePassword">Password </label>
              <input
          ...
          <div>
            <br></br>
            <input type="submit" onClick={this.login} className="but"  value="Sign in"/>
           </div>
