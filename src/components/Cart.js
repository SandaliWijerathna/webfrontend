...
const Cart = () => {
  ...
  return(
       ...
       <card className="hove1"> 
        <div className="tab1">
    <ReactBootStrap.Table striped bordered hover className="t1">
  <thead className="th1">
    <tr>
      <th>Item No</th>
      <th>Item Name</th>
...
<Button color="danger" className="b1" onClick={() => history.push('online')}>Online</Button>

&nbsp;
<Button color="danger" className="b1" onClick={() => history.push('qrcode')}>Cash</Button>
</div>
</card> 
