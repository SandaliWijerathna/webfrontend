    ...
    return (
      <div className="wrap2">
        <div className="form-wrap2">
          ...
          <h1 className="oni">Sign Up</h1>
          
          <form  method="post"  name="userRegistrationForm"  onSubmit= {this.submituserRegistrationForm}className="LoginForm">
        
        <label>Name:</label>
        <input type="text" name="username" value={this.state.fields.username} onChange={this.handleChange} className="xcs1"/>
        <div className="errorMsg">{this.state.errors.username}</div>
        <label>Email:</label>
        <input type="text" name="email" value={this.state.fields.email} onChange={this.handleChange} className="xcs1" />
        <div className="errorMsg">{this.state.errors.email}</div>
        <label>Mobile No:</label>
        <input type="text" name="mobile" value={this.state.fields.mobile} onChange={this.handleChange} className="xcs1"  />
        <div className="errorMsg">{this.state.errors.mobile}</div>
        <label>Password:</label>
        <input type="password" name="password" value={this.state.fields.password} onChange={this.handleChange}className="xcs1" />
        <div className="errorMsg">{this.state.errors.password}</div>
        <label>Address:</label>
        <input type="text" name="address" value={this.state.fields.address} onChange={this.handleChange} className="xcs1"/>
        <div className="errorMsg">{this.state.errors.address}</div>
        <label>Account Number:</label>
        <input type="text" name="account" value={this.state.fields.account} onChange={this.handleChange} className="xcs1"/>
        ...
        <label>
              ...
              <div><br></br><center>
              <input type="submit" className="but1" value="Register" /></center>
              </div>
          </form>
        </div>
      </div>
